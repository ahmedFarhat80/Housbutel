...
<head>
    ...
    <meta name="keywords" content="المستشفى العسكري الكويتي لحجز المواعيد الطبية" />
    ...
    <link href="{{ asset('Backend/assets/plugins/custom/fullcalendar/fullcalendar.bundle.rtl.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('Backend/assets/plugins/custom/datatables/datatables.bundle.rtl.css') }}" rel="stylesheet"
        type="text/css" />
    ...
    <script>
        permission(click - jacking) if (window.top != window.self) {
