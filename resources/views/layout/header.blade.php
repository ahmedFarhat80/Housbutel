                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        ...
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/amazon.svg') }}"
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/angular-icon-1.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/atica.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/beats-electronics.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/codeigniter.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/bootstrap-4.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/google-tag-manager.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/disqus.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/dribbble-icon-1.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/google-play-store.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/google-podcasts.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/github.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/gitlab.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/instagram-2-1.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                                ...
                                                <div class="col-4">
                                                    <a href="#"
                                                        class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                        <img src="{{ asset('Backend/assets/media/svg/brand-logos/pinterest-p.svg') }}"
                                                            class="w-25px h-25px mb-2" alt="" />
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="../../demo1/dist/account/settings.html"
                                                ...
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1"
                                                        src="{{ asset('Backend/assets/media/flags/united-states.svg') }}" alt="" />
                                                </span>English</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
